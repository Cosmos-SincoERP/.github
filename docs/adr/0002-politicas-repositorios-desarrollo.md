...
- **Nota**: esta entrada cubre la *restricción de quién puede crear* repos. La *habilitación del proceso* de creación conforme se decide en [[0004]] (refinado por [[0005]]) y es ortogonal a esta restricción.
